Feature: Homework : AA(ACTIVITY) event validations
   @CAP-140
   Scenario Outline: Mindtap users Calculate the Total Homework : AA(ACTIVITY) event in Analytics Tool
      ...
      Examples:
         ...
         | alok_inst@swlearning.com | course    | course-key     | MTPPR1GPNWJG | reverse | ACTIVITY    | LAUNCH      | 9781133354215 | GTM         |

   @CAP-140
   Scenario Outline: Mindtap users performs a Homework : AA(ACTIVITY) event
      ...
      Examples:
         ...
         | alok_inst@swlearning.com | Password1 |  MTPPR1GPNWJG    | Homework : AA       | int          | 9781133354215 |

   @CAP-140
   Scenario Outline: Mindtap users Verify the Homework : AA(ACTIVITY) event in Analytics Tool
      Given As a user, I launch ADT URL with the following query string <QueryType> , <QueryAttribute> , <Parameter> , <Tab> , <ISBN>
      And I search and select a user with <Search_Data> in SSO UID
      When I search events with the following parameter <EventCategory>,<EventAction>,<EventSource>
      ...
      Examples:
         ...
         | alok_inst@swlearning.com | course    | course-key     | MTPPR1GPNWJG | reverse | ACTIVITY    | LAUNCH      | 9781133354215 | GTM         | 1     |
